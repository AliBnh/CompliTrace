...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+psycopg://postgres:postgres@postgres:5432/complitrace", alias="DATABASE_URL"
    )
    ...
    auth_service_url: str = Field(default="http://auth-service:8004", alias="AUTH_SERVICE_URL")
